...
const index = async (req, res) => {
    try {
        ...
        const totalCount = await ReceivedMailModel.countDocuments({ ...searchQuery, is_draft: false, recipient_id: req.AuthUser._id, is_trash: false, deleted_at: null });
        
        const mail_query = await ReceivedMailModel.find({ ...searchQuery, is_draft: false, recipient_id: req.AuthUser._id, is_trash: false, deleted_at: null })
...
const move_to_received_mails = async (req, res) => {
    try {
        //
    }
    catch (error) {
