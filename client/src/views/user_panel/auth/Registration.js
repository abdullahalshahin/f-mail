...
export class Registration extends Component {
    ...
    handleSubmit = async (e) => {
        ...
        try {
            const response = await AxiosAPI.post(`/api/registration`, {
            ...
            if (this.state.remember_me) {
                localStorage.setItem('remembered_username', this.state.username);
                                        ...
                                        <form onSubmit={this.handleSubmit}>
                                            ...
                                            <div className="row g-2">
                                                ...
                                                <div className="mb-2 col-md-4">
                                                    ...
                                                    <input type="text" className="form-control" id="username" name="username" value={this.state.username} onChange={this.handleInputChange} placeholder="e.g: example@f-mail.com" required />
                                                </div>
