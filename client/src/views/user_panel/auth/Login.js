...
export class Login extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            remember_me: localStorage.getItem('remembered_username') ? true : false,
            error: ''
        };
    }
                                    ...
                                    <div className="card-body px-4">
                                        ...
                                        <form onSubmit={this.handleSubmit}>
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <input className="form-control" type="email" id="username" placeholder="Enter your mail" value={this.state.username} onChange={this.handleInputChange} required />
                                            </div>
